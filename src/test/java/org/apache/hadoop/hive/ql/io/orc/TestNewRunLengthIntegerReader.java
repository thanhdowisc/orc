...
public class TestNewRunLengthIntegerReader {

  public void runSeekTest(CompressionCodec codec) throws Exception {
    TestInStream.OutputCollector collect = new TestInStream.OutputCollector();
    NewRunLengthIntegerWriter out = new NewRunLengthIntegerWriter(
    ...
    inBuf.flip();
    NewRunLengthIntegerReader in = new NewRunLengthIntegerReader(InStream.create
