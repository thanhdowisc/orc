...
import org.apache.hadoop.hive.ql.io.file.orc.OrcSerde.OrcSerdeRow;
...
public class OrcOutputFormat extends FileOutputFormat<NullWritable, OrcSerdeRow>
  ...
  public FileSinkOperator.RecordWriter
    ...
    String compression = tableProperties.getProperty
        (OrcFile.COMPRESSION, OrcFile.DEFAULT_COMPRESSION);
    ...
    return new OrcRecordWriter(path.getFileSystem(conf), path, conf,
      stripeSize, compression, compressionSize);
  }
}
